...
<head>
    ...
    <title>Order Notification | Test eCommerce</title>
</head>
    ...
    <div class="container" style="background-color: #e7eff8; width: 600px; margin: auto;">
        <div class="col-12 mx-auto" style="width: 580px;  margin: 0 auto;">
            ...
            <div class="row" style="background-color: #00509d; height: 200px; padding: 35px; color: white;">
                <div class="container-fluid">
                    <h3 class="m-0 p-0 mt-4" style=" color: white !important; margin-top: 0; font-size: 28px; font-weight: 500;">
                        <strong style="color: white !important; font-size: 32px;">Order Notification</strong>
                        <br>
                        Thank you very much
                    </h3>
                    <div class="row mt-5" style="margin-top: 35px; display: flex;">
                        <div class="col-6"
                            ...
                            <br>
                            <span style="color: white !important;">{{ $order->phone }}</span>
                        </div>
                        <div class="col-6" style="color: white !important; flex: 0 0 50%; width: 50%; box-sizing: border-box;">
                            <b>Order date:</b> {{ date('d/m/yy H:i', strtotime($order->created_at)) }}
                            <br>
                            <b style="color: white !important;">Address:</b> 
                            <span style="color: white !important;">{{ $order->street_address . ' - ' .  $order->town_city }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2 p-4" style="background-color: white; margin-top: 15px; padding: 20px;">
                <table>
                    <tr>
                        ...
                        @elseif ($order->payment_type == "online_payment")
                            <td class="pl-3" style=" padding-left:15px;">
                                <span class="d-inline"
                                      style="color:#424853; font-family:trebuchet,sans-serif; font-size:16px; font-weight:normal; line-height:22px;">
